...
class Encoder(nn.Module):
    ...
    def __init__(self, encoded_image_size=14):
        ...
        mobilenet = torchvision.models.mobilenet_v3_small(weights=torchvision.models.MobileNet_V3_Small_Weights.IMAGENET1K_V1)
        modules = list(mobilenet.children())[:-1]  # Remove the classification head
...
class DecoderWithAttention(nn.Module):
    ...
    def __init__(self, attention_dim, embed_dim, decoder_dim, vocab_size, encoder_dim=576, dropout=0.5):
        """
...
class DecoderWithoutAttention(nn.Module):
    ...
    """
    def __init__(self, embed_dim, decoder_dim, vocab_size, encoder_dim=576, dropout=0.5):
        """
