...
class Encoder(nn.Module):
    ...
    def __init__(self, encoded_image_size=14):
        ...
        mnasnet = torchvision.models.mnasnet0_5(weights=torchvision.models.MNASNet0_5_Weights.IMAGENET1K_V1)
        modules = list(mnasnet.children())[:-1]  # Remove the classification head
